...
_supported_layers = ['Linear', 'Conv2d', 'SparseFeaturesEmbedding']  # Supported layer class types
...
def compute_grad1(model: nn.Module, loss_type: str = 'mean') -> None:
    ...
    for layer in model.modules():
        ...
        elif layer_type == 'SparseFeaturesEmbedding':
            setattr(layer.weight, 'grad1', torch.bmm(A.unsqueeze(-1), B.unsqueeze(1)))
